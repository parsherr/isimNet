...
export default function MusterilerPage() {
  const { customers, addCustomer, getCustomerTotals, isLoading } = useData();
    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-4 py-6 pb-24">
        ...
        {isLoading ? (
          ...
          <>
            <CustomerStatsBar customerCount={customers.length} totalOutstandingDebt={totalOutstandingDebt} />
            <div className="mt-4">
              <SearchInput value={searchQuery} onChange={setSearchQuery} placeholder="Müşteri ara..." />
            </div>
            <div className="flex flex-col gap-3 mt-4">
      ...
      <NewCustomerModal open={isModalOpen} onClose={() => setIsModalOpen(false)} onSubmit={handleAddCustomer} />
    </div>
  );
}